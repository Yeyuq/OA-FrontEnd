      ...
      <el-form :model="registerForm" status-icon :rules="rules" ref="registerForm" label-width="100px"
        ...
        <el-tabs v-model="active">
          ...
          <el-tab-pane name="2" class="tab_finish">
            <i class="el-icon-success" style="color: #409EFF;font-size: 129px;margin-left: 160px"></i>
            <p style="text-align: center">您已注册成功！</p>
            <p style="text-align: center">点击按钮返回登录界面</p>
            <el-button type="primary" style="margin-left: 181px" @click="loginForm(registerForm)">去登录</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </div>
